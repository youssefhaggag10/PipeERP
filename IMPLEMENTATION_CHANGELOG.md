...
| RPT-1 | Web had A4 only | **Fixed**: added 80mm thermal print mode using the same document data | `ReportsPage.tsx`, `styles.css` | Frontend tests/build and print CSS review |
